...
const competences = [
  { id: 1, name: 'Desenvolvedor Front-End', value: 'DEVFE' },
  { id: 2, name: 'Desenvolvedor Back-End', value: 'DEVBE' },
  { id: 3, name: 'Desenvolvedor FullStack', value: 'DEVFS' },
  { id: 4, name: 'Desenvolvedor Mobile', value: 'DEVMB' }
];
